...
let timers = clockString(_ctimer)
  ...
  if (4999 > user.money) throw '❗Dia Tidak Memiliki Modal Harap Masukkan Modal Minimal $.5000'
  if (4999 > user.money) throw '❗Kamu Tidak Memiliki Modal Harap Masukkan Modal Minimal $.5000'
  ...
  let _caption = `Selamat @${m.sender.split("@")[0]} Dan @${who.split("@")[0]} Mendapatkan Uang..\n\nPenghasilan Dagang @${m.sender.split("@")[0]} Mendapatkan: $.5000\n${user.money += 5000}\n\nPenghasilan Dagang @${who.split("@")[0]} Mendapatkan $.5000\n${user.money += 5000}`
  
  let __caption = `*SUKSES*\nSelamat @${m.sender.split("@")[0]} Dan @${who.split("@")[0]} Mendapatkan Uang..\n\nPenghasilan Dagang @${m.sender.split("@")[0]} Mendapatkan $.10000\n${user.money += 10000}\n\nPenghasilan Dagang @${who.split("@")[0]} Mendapatkan $.10000\n${user.money += 10000}`
